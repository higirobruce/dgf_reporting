...
if (isset($_POST['month_of'])) {
    $month = $_POST['month_of'];
    $year = $_POST['year_of'];
} else {
    $month = 6;
    $year = 2018;
...
left join CLEARINGUSER.CLASSIFICATION_HIS cl on trim(a.cli) = trim(cl.cli) and cl.month=? and cl.year=?
left join (
...
in ('924100','924110','924111','924120','924121',
'924130','924131','924200','924210','924211',
'924400','924910','924911','925200','925210',
'925211','925220','925221','925230','925231',
'925900','925910','925911','902100')

and a.dco=? and a.sde<0

group by trim(d.lib), A.NCP, b.cli, b.nomrest, c.ben,
case when a.dev='646' then 'RWF' when a.dev = '840' then 'USD' when a.dev = '978' then 'EUR' end, a.sdecv, cla.newcla, TO_CHAR(TRIM(col_type.lib)), a.cha,a.age
--and a.sde<0

--and a.cli='0054188'

) a
left join (select eve, ncpe from prod.bkcau) cau_unique on cau_unique.eve = a.caution_id
...
b.dco, b.dech,a.cha,chap.lib,a.age_code,classif.newcla,
classif.ndaysarr
